...
//localhost:2000/hello/guys
//HASIL : Hello guys


app.get('/*ily*/:nama', function(req,res){
    res.send('ILY ' + req.params.nama)
})
//localhost:3000/ABCilyOPQ/123
//HASIL : ILY 123


let cb = function(req,res){
    res.send('Testing '+ req.params.nama)
}
app.get('/bye/:nama', cb)
//localhost:4000/bye/123
//HASIL : Testing 123
